 ...
 * 맨 앞의 codec의 decode() 메소드가 반환하는 객체(ReadBuffer)의 내용이 remote로 전송된다.
 *
...
interface CoCodec {
     ...
     */
    suspend fun encode(conn: CoConnection, inObj: Any): Any?
     ...
     */
    suspend fun decode(conn: CoConnection, outObj: Any): Any
}